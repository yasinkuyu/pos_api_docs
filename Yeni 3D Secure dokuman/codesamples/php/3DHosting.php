...
$okUrl = "http://<mağaza_sunucu_adresi>/3DHostingOdeme.php";      //Islem basariliysa dönülecek isyeri sayfasi  (3D isleminin ve ödeme isleminin sonucu)
$failUrl = "http://<mağaza_sunucu_adresi>/3DHostingOdeme.php";    //Islem basarisizsa dönülecek isyeri sayfasi  (3D isleminin ve ödeme isleminin sonucu)
