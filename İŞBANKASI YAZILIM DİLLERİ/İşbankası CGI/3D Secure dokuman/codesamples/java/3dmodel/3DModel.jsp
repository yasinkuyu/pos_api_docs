...
<html>
    ...
    <%
        ...
        * Form dışındaki alanların hidden text olarak post gerekmektedir. */
        ...
        String okUrl = "http://<magaza_sunucu_adresi>/3dmodel/odemesayfasi.jsp";   //İşlem başarılıysa dönülecek işyeri sayfası  (3D işleminin sonucu ödeme işleminin değil)
        String failUrl = "http://<magaza_sunucu_adresi>/3dmodel/odemesayfasi.jsp"; //İşlem başarısız ise dönülecek işyeri sayfası(3D işleminin sonucu ödeme işleminin değil)
        String rnd = new java.util.Date().toString(); // Tarih veya her seferinde değişen bir değer güvenlik amaçlı kullanılıyor
        
        String storekey="xxxxxx";       //İşyeri ayıracı (işyeri anahtarı)
